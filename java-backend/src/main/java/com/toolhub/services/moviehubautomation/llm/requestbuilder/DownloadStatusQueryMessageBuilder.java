...
public class DownloadStatusQueryMessageBuilder implements BaseOpenAiMessageBuilder {

  @Override
  public JsonObject buildMessage(MediaState mediaState, String userInput) {
    String content =
        Templates.DOWNLOAD_STATUS_QUERY_PROMPT.replace("{USER_INPUT}", valueOrMissing(userInput));
