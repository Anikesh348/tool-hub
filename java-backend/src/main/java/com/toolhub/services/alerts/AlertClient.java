...
public class AlertClient {
  ...
  public AlertClient(
      User user, JsonObject productInfo, Product product, Vertx vertx, WebClient client) {
  ...
  public AlertClient(
    ...
    this.vertx = vertx;
    this.client = client;
    this.matchingTargetPrices =
        matchingTargetPrices == null ? java.util.List.of() : matchingTargetPrices;
  }
  ...
  public void sendAlerts() {
    ...
    emailAlertService
        .sendEmail(subject, toEmail, body)
        .onSuccess(
            res -> {
